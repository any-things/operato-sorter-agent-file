...
import xyz.anythings.sorter.tcp.ITcpServerMessageHandler;
...
@Service
@Transactional
public class TcpServerMessageHandler implements ITcpServerMessageHandler {
	...
	public void receive(String serverAddress, IoSession clientSession, String message) {
		try {
			...
			TcpUtil.closeSession(clientSession);
